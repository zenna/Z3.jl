...
typealias BoolPtr Ptr{Void}
typealias FixedpointReduceAssignCallbackFptrPtr Ptr{Void}
typealias FixedpointReduceAppCallbackFptrPtr Ptr{Void}

#ifdef CorML3
type Z3Symbol ptr::Z3SymbolPtr end
type Literals ptr::LiteralsPtr end
type Theory ptr::TheoryPtr end
type Config ptr::ConfigPtr end
type Context ptr::ContextPtr end
type Sort ptr::SortPtr end
#define Z3SortOpt Z3Sort
type FuncDecl ptr::FuncDeclPtr end
type Ast ptr::AstPtr end
#define Z3AstOpt Z3Ast
type App ptr::AppPtr end
type Pattern ptr::PatternPtr end
type Model ptr::ModelPtr end
type Constructor ptr::ConstructorPtr end
type ConstructorList ptr::ConstructorListPtr end
#endif
#ifdef Conly
type Params ptr::ParamsPtr end
type ParamDescrs ptr::ParamDescrsPtr end
type Goal ptr::GoalPtr end
type Tactic ptr::TacticPtr end
type Probe ptr::ProbePtr end
type Stats ptr::StatsPtr end
type Solver ptr::SolverPtr end
type AstVector ptr::AstVectorPtr end
type AstMap ptr::AstMapPtr end
type ApplyResult ptr::ApplyResultPtr end
type FuncInterp ptr::FuncInterpPtr end
#define Z3FuncInterpOpt Z3FuncInterp
type FuncEntry ptr::FuncEntryPtr end
type Fixedpoint ptr::FixedpointPtr end
type RcfNum ptr::RcfNumPtr end
type TheoryData ptr::TheoryDataPtr end #Is actually a void ptr


## Function Typedefs
type ReduceEqCallbackFptr ptr::ReduceEqCallbackFptrPtr end
type ReduceAppCallbackFptr ptr::ReduceAppCallbackFptrPtr end
type ReduceDistinctCallbackFptr ptr::ReduceDistinctCallbackFptrPtr end
type TheoryCallbackFptr ptr::TheoryCallbackFptrPtr end
type TheoryFinalCheckCallbackFptr ptr::TheoryFinalCheckCallbackFptrPtr end
type TheoryAstBoolCallbackFptr ptr::TheoryAstBoolCallbackFptrPtr end
type TheoryAstAstCallbackFptr ptr::TheoryAstAstCallbackFptrPtr end
type TheoryAstCallbackFptr ptr::TheoryAstCallbackFptrPtr end

type Bool ptr::BoolPtr end

type FixedpointReduceAssignCallbackFptr ptr::FixedpointReduceAssignCallbackFptrPtr end
type FixedpointReduceAppCallbackFptr ptr::FixedpointReduceAppCallbackFptrPtr end
...
function convert_arg(arg::Expr)
  Expr(:(::), arg_name(arg), tojulia(arg_type(arg)))
end
...
macro wrap(return_type, func_def)
  ...
  @show func_decl = Expr(:function, params, api_call)
  @show :(begin
            $func_def
            $func_decl
          end)
...
function Z3_global_param_set(param_id::Ptr{Uint8},param_value::Ptr{Uint8})
    ccall((:Z3_global_param_set,"libz3"),Void,(Ptr{Uint8},Ptr{Uint8}),param_id,param_value)
end
...
function Z3_global_param_get(param_id::Ptr{Uint8},_ptr::Ptr{Uint8})
    ccall((:Z3_global_param_get,"libz3"),Z3_bool,(Ptr{Uint8},Ptr{Uint8}),param_id,_ptr)
end
...
function Z3_set_param_value(c::Z3_config,param_id::Ptr{Uint8},param_value::Ptr{Uint8})
    ccall((:Z3_set_param_value,"libz3"),Void,(Z3_config,Ptr{Uint8},Ptr{Uint8}),c,param_id,param_value)
end

function Z3_mk_context(c::Z3_config)
...
function Z3_update_param_value(c::Z3_context,param_id::Ptr{Uint8},param_value::Ptr{Uint8})
    ccall((:Z3_update_param_value,"libz3"),Void,(Z3_context,Ptr{Uint8},Ptr{Uint8}),c,param_id,param_value)
end
...
function Z3_params_to_string(c::Z3_context,p::Z3_params)
    ccall((:Z3_params_to_string,"libz3"),Ptr{Uint8},(Z3_context,Z3_params),c,p)
end
...
function Z3_param_descrs_to_string(c::Z3_context,p::Z3_param_descrs)
    ccall((:Z3_param_descrs_to_string,"libz3"),Ptr{Uint8},(Z3_context,Z3_param_descrs),c,p)
end
...
function Z3_mk_string_symbol(c::Z3_context,s::Ptr{Uint8})
    ccall((:Z3_mk_string_symbol,"libz3"),Z3_symbol,(Z3_context,Ptr{Uint8}),c,s)
end
...
@wrap Z3_sort function Z3_mk_bv_sort(c::Z3_context,sz::Uint32)
...
function Z3_mk_fresh_func_decl(c::Z3_context,prefix::Ptr{Uint8},domain_size::Uint32,domain::Ptr{Z3_sort},range::Z3_sort)
    ccall((:Z3_mk_fresh_func_decl,"libz3"),Z3_func_decl,(Z3_context,Ptr{Uint8},Uint32,Ptr{Z3_sort},Z3_sort),c,prefix,domain_size,domain,range)
end

function Z3_mk_fresh_const(c::Z3_context,prefix::Ptr{Uint8},ty::Z3_sort)
    ccall((:Z3_mk_fresh_const,"libz3"),Z3_ast,(Z3_context,Ptr{Uint8},Z3_sort),c,prefix,ty)
end
...
function Z3_mk_numeral(c::Z3_context,numeral::Ptr{Uint8},ty::Z3_sort)
    ccall((:Z3_mk_numeral,"libz3"),Z3_ast,(Z3_context,Ptr{Uint8},Z3_sort),c,numeral,ty)
end
...
function Z3_get_symbol_string(c::Z3_context,s::Z3_symbol)
    ccall((:Z3_get_symbol_string,"libz3"),Ptr{Uint8},(Z3_context,Z3_symbol),c,s)
end
...
function Z3_get_decl_rational_parameter(c::Z3_context,d::Z3_func_decl,idx::Uint32)
    ccall((:Z3_get_decl_rational_parameter,"libz3"),Ptr{Uint8},(Z3_context,Z3_func_decl,Uint32),c,d,idx)
end
...
function Z3_get_numeral_string(c::Z3_context,a::Z3_ast)
    ccall((:Z3_get_numeral_string,"libz3"),Ptr{Uint8},(Z3_context,Z3_ast),c,a)
end

function Z3_get_numeral_decimal_string(c::Z3_context,a::Z3_ast,precision::Uint32)
    ccall((:Z3_get_numeral_decimal_string,"libz3"),Ptr{Uint8},(Z3_context,Z3_ast,Uint32),c,a,precision)
end
...
function Z3_simplify_get_help(c::Z3_context)
    ccall((:Z3_simplify_get_help,"libz3"),Ptr{Uint8},(Z3_context,),c)
end
...
function Z3_open_log(filename::Ptr{Uint8})
    ccall((:Z3_open_log,"libz3"),Z3_bool,(Ptr{Uint8},),filename)
end

function Z3_append_log(string::Ptr{Uint8})
    ccall((:Z3_append_log,"libz3"),Void,(Ptr{Uint8},),string)
end
...
function Z3_ast_to_string(c::Z3_context,a::Z3_ast)
    ccall((:Z3_ast_to_string,"libz3"),Ptr{Uint8},(Z3_context,Z3_ast),c,a)
end

function Z3_pattern_to_string(c::Z3_context,p::Z3_pattern)
    ccall((:Z3_pattern_to_string,"libz3"),Ptr{Uint8},(Z3_context,Z3_pattern),c,p)
end

function Z3_sort_to_string(c::Z3_context,s::Z3_sort)
    ccall((:Z3_sort_to_string,"libz3"),Ptr{Uint8},(Z3_context,Z3_sort),c,s)
end

function Z3_func_decl_to_string(c::Z3_context,d::Z3_func_decl)
    ccall((:Z3_func_decl_to_string,"libz3"),Ptr{Uint8},(Z3_context,Z3_func_decl),c,d)
end

function Z3_model_to_string(c::Z3_context,m::Z3_model)
    ccall((:Z3_model_to_string,"libz3"),Ptr{Uint8},(Z3_context,Z3_model),c,m)
end

function Z3_benchmark_to_smtlib_string(c::Z3_context,name::Ptr{Uint8},logic::Ptr{Uint8},status::Ptr{Uint8},attributes::Ptr{Uint8},num_assumptions::Uint32,assumptions::Ptr{Z3_ast},formula::Z3_ast)
    ccall((:Z3_benchmark_to_smtlib_string,"libz3"),Ptr{Uint8},(Z3_context,Ptr{Uint8},Ptr{Uint8},Ptr{Uint8},Ptr{Uint8},Uint32,Ptr{Z3_ast},Z3_ast),c,name,logic,status,attributes,num_assumptions,assumptions,formula)
end

function Z3_parse_smtlib2_string(c::Z3_context,str::Ptr{Uint8},num_sorts::Uint32,sort_names::Ptr{Z3_symbol},sorts::Ptr{Z3_sort},num_decls::Uint32,decl_names::Ptr{Z3_symbol},decls::Ptr{Z3_func_decl})
    ccall((:Z3_parse_smtlib2_string,"libz3"),Z3_ast,(Z3_context,Ptr{Uint8},Uint32,Ptr{Z3_symbol},Ptr{Z3_sort},Uint32,Ptr{Z3_symbol},Ptr{Z3_func_decl}),c,str,num_sorts,sort_names,sorts,num_decls,decl_names,decls)
end

function Z3_parse_smtlib2_file(c::Z3_context,file_name::Ptr{Uint8},num_sorts::Uint32,sort_names::Ptr{Z3_symbol},sorts::Ptr{Z3_sort},num_decls::Uint32,decl_names::Ptr{Z3_symbol},decls::Ptr{Z3_func_decl})
    ccall((:Z3_parse_smtlib2_file,"libz3"),Z3_ast,(Z3_context,Ptr{Uint8},Uint32,Ptr{Z3_symbol},Ptr{Z3_sort},Uint32,Ptr{Z3_symbol},Ptr{Z3_func_decl}),c,file_name,num_sorts,sort_names,sorts,num_decls,decl_names,decls)
end

function Z3_parse_smtlib_string(c::Z3_context,str::Ptr{Uint8},num_sorts::Uint32,sort_names::Ptr{Z3_symbol},sorts::Ptr{Z3_sort},num_decls::Uint32,decl_names::Ptr{Z3_symbol},decls::Ptr{Z3_func_decl})
    ccall((:Z3_parse_smtlib_string,"libz3"),Void,(Z3_context,Ptr{Uint8},Uint32,Ptr{Z3_symbol},Ptr{Z3_sort},Uint32,Ptr{Z3_symbol},Ptr{Z3_func_decl}),c,str,num_sorts,sort_names,sorts,num_decls,decl_names,decls)
end

function Z3_parse_smtlib_file(c::Z3_context,file_name::Ptr{Uint8},num_sorts::Uint32,sort_names::Ptr{Z3_symbol},sorts::Ptr{Z3_sort},num_decls::Uint32,decl_names::Ptr{Z3_symbol},decls::Ptr{Z3_func_decl})
    ccall((:Z3_parse_smtlib_file,"libz3"),Void,(Z3_context,Ptr{Uint8},Uint32,Ptr{Z3_symbol},Ptr{Z3_sort},Uint32,Ptr{Z3_symbol},Ptr{Z3_func_decl}),c,file_name,num_sorts,sort_names,sorts,num_decls,decl_names,decls)
end
...
function Z3_get_smtlib_error(c::Z3_context)
    ccall((:Z3_get_smtlib_error,"libz3"),Ptr{Uint8},(Z3_context,),c)
end
...
function Z3_get_error_msg(err::Z3_error_code)
    ccall((:Z3_get_error_msg,"libz3"),Ptr{Uint8},(Z3_error_code,),err)
end

function Z3_get_error_msg_ex(c::Z3_context,err::Z3_error_code)
    ccall((:Z3_get_error_msg_ex,"libz3"),Ptr{Uint8},(Z3_context,Z3_error_code),c,err)
end
...
function Z3_get_version(major,minor,build_number,revision_number)
  ccall((:Z3_get_version,"libz3"),Void,(Ref{Uint32},Ref{Uint32},Ref{Uint32},Ref{Uint32}),
  major, minor, build_number, revision_number)
end

function Z3_enable_trace(tag::Ptr{Uint8})
    ccall((:Z3_enable_trace,"libz3"),Void,(Ptr{Uint8},),tag)
end

function Z3_disable_trace(tag::Ptr{Uint8})
    ccall((:Z3_disable_trace,"libz3"),Void,(Ptr{Uint8},),tag)
end
...
function Z3_mk_theory(c::Z3_context,th_name::Ptr{Uint8},data::Z3_theory_data)
    ccall((:Z3_mk_theory,"libz3"),Z3_theory,(Z3_context,Ptr{Uint8},Z3_theory_data),c,th_name,data)
end
...
function Z3_fixedpoint_get_reason_unknown(c::Z3_context,d::Z3_fixedpoint)
    ccall((:Z3_fixedpoint_get_reason_unknown,"libz3"),Ptr{Uint8},(Z3_context,Z3_fixedpoint),c,d)
end
...
function Z3_fixedpoint_get_help(c::Z3_context,f::Z3_fixedpoint)
    ccall((:Z3_fixedpoint_get_help,"libz3"),Ptr{Uint8},(Z3_context,Z3_fixedpoint),c,f)
end
...
function Z3_fixedpoint_to_string(c::Z3_context,f::Z3_fixedpoint,num_queries::Uint32,queries::Ptr{Z3_ast})
    ccall((:Z3_fixedpoint_to_string,"libz3"),Ptr{Uint8},(Z3_context,Z3_fixedpoint,Uint32,Ptr{Z3_ast}),c,f,num_queries,queries)
end

function Z3_fixedpoint_from_string(c::Z3_context,f::Z3_fixedpoint,s::Ptr{Uint8})
    ccall((:Z3_fixedpoint_from_string,"libz3"),Z3_ast_vector,(Z3_context,Z3_fixedpoint,Ptr{Uint8}),c,f,s)
end

function Z3_fixedpoint_from_file(c::Z3_context,f::Z3_fixedpoint,s::Ptr{Uint8})
    ccall((:Z3_fixedpoint_from_file,"libz3"),Z3_ast_vector,(Z3_context,Z3_fixedpoint,Ptr{Uint8}),c,f,s)
end
...
function Z3_ast_vector_to_string(c::Z3_context,v::Z3_ast_vector)
    ccall((:Z3_ast_vector_to_string,"libz3"),Ptr{Uint8},(Z3_context,Z3_ast_vector),c,v)
end
...
function Z3_ast_map_to_string(c::Z3_context,m::Z3_ast_map)
    ccall((:Z3_ast_map_to_string,"libz3"),Ptr{Uint8},(Z3_context,Z3_ast_map),c,m)
end
...
function Z3_goal_to_string(c::Z3_context,g::Z3_goal)
    ccall((:Z3_goal_to_string,"libz3"),Ptr{Uint8},(Z3_context,Z3_goal),c,g)
end

function Z3_mk_tactic(c::Z3_context,name::Ptr{Uint8})
    ccall((:Z3_mk_tactic,"libz3"),Z3_tactic,(Z3_context,Ptr{Uint8}),c,name)
end
...
function Z3_mk_probe(c::Z3_context,name::Ptr{Uint8})
    ccall((:Z3_mk_probe,"libz3"),Z3_probe,(Z3_context,Ptr{Uint8}),c,name)
end
...
function Z3_get_tactic_name(c::Z3_context,i::Uint32)
    ccall((:Z3_get_tactic_name,"libz3"),Ptr{Uint8},(Z3_context,Uint32),c,i)
end
...
function Z3_get_probe_name(c::Z3_context,i::Uint32)
    ccall((:Z3_get_probe_name,"libz3"),Ptr{Uint8},(Z3_context,Uint32),c,i)
end

function Z3_tactic_get_help(c::Z3_context,t::Z3_tactic)
    ccall((:Z3_tactic_get_help,"libz3"),Ptr{Uint8},(Z3_context,Z3_tactic),c,t)
end
...
function Z3_tactic_get_descr(c::Z3_context,name::Ptr{Uint8})
    ccall((:Z3_tactic_get_descr,"libz3"),Ptr{Uint8},(Z3_context,Ptr{Uint8}),c,name)
end

function Z3_probe_get_descr(c::Z3_context,name::Ptr{Uint8})
    ccall((:Z3_probe_get_descr,"libz3"),Ptr{Uint8},(Z3_context,Ptr{Uint8}),c,name)
end
...
function Z3_apply_result_to_string(c::Z3_context,r::Z3_apply_result)
    ccall((:Z3_apply_result_to_string,"libz3"),Ptr{Uint8},(Z3_context,Z3_apply_result),c,r)
end
...
function Z3_solver_get_help(c::Z3_context,s::Z3_solver)
    ccall((:Z3_solver_get_help,"libz3"),Ptr{Uint8},(Z3_context,Z3_solver),c,s)
end
...
function Z3_solver_get_reason_unknown(c::Z3_context,s::Z3_solver)
    ccall((:Z3_solver_get_reason_unknown,"libz3"),Ptr{Uint8},(Z3_context,Z3_solver),c,s)
end
...
function Z3_solver_to_string(c::Z3_context,s::Z3_solver)
    ccall((:Z3_solver_to_string,"libz3"),Ptr{Uint8},(Z3_context,Z3_solver),c,s)
end

function Z3_stats_to_string(c::Z3_context,s::Z3_stats)
    ccall((:Z3_stats_to_string,"libz3"),Ptr{Uint8},(Z3_context,Z3_stats),c,s)
end
...
function Z3_stats_get_key(c::Z3_context,s::Z3_stats,idx::Uint32)
    ccall((:Z3_stats_get_key,"libz3"),Ptr{Uint8},(Z3_context,Z3_stats,Uint32),c,s,idx)
end
...
function Z3_set_logic(c::Z3_context,logic::Ptr{Uint8})
    ccall((:Z3_set_logic,"libz3"),Z3_bool,(Z3_context,Ptr{Uint8}),c,logic)
end
...
function Z3_context_to_string(c::Z3_context)
    ccall((:Z3_context_to_string,"libz3"),Ptr{Uint8},(Z3_context,),c)
end

function Z3_statistics_to_string(c::Z3_context)
    ccall((:Z3_statistics_to_string,"libz3"),Ptr{Uint8},(Z3_context,),c)
end
